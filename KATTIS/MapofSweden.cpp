...
void solve() {
    ...
    for (int i = 0; i < u; i++) {
        ...
        if (tempx > 0 && visited[tempx - 1][tempy]) connected = true;
        if (tempx < row_num - 1 && visited[tempx + 1][tempy]) connected = true;
        if (tempy > 0 && visited[tempx][tempy - 1]) connected = true;
        if (tempy < col_num - 1 && visited[tempx][tempy + 1]) connected = true;
